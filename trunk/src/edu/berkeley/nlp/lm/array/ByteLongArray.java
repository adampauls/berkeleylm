...
final class ByteLongArray implements Serializable, LongArray
{
	...
	protected ByteLongArray(final long initialCapacity) {
		this.size = 0;
	...
	private void check(final long capacity) {
		if (capacity >= Integer.MAX_VALUE) throw new IllegalArgumentException(capacity + " to big for " + ByteLongArray.class.getSimpleName());
	}
	...
	public static void main(final String[] argv) {
		...
		final LongArray b = new ByteLongArray(5L + Integer.MAX_VALUE / 9);
