...
public class LmReaders
{
	...
	public static <W> KatzBackoffLm<W> readArpaLmFile(final NgramMapOpts opts, final String lmFile, final int lmOrder, final WordIndexer<W> wordIndexer,
		...
		final ValueAddingCallback<ProbBackoffPair> valueAddingCallback = new ValueAddingCallback<ProbBackoffPair>();
		...
		final NgramMap<ProbBackoffPair> map = new HashNgramMap<ProbBackoffPair>(values, new MurmurHash(), opts, 100000);
